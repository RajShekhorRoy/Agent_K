...
def build_planner_prompt(state: AgentState) -> str:
    ...
    state_view = {
        ...
        "pathway_id":  getattr(state, "pathway_id", None),
    ...
    few_shots = (
        ...
        "User: run antismash for this file /Data/file/oppp.gbk \n"
        "Assistant:\n"
        '{"action":"run_antismash","args":{"genbank_path":"/Data/file/oppp.gbk"},"notes":"running antismash but no output directory provided"}\n\n'

        "User: Can you run antismash for the genebank file /Data/file/oppp.gbk and output directory  /home/rajroy/etc/  \n"
        "Assistant:\n"
        '{"action":"run_antismash","args":{"genbank_path":"/Data/file/oppp.gbk", "antismash_dir":"/home/rajroy/etc/"},"notes":"running antismash but no output directory provided"}\n\n'
        ...
        "User: show me analysis bgc BGC0000888.5 \n"
        "Assistant:\n"
    ...
    return (
        ...
        "- If user asks provides genebank file path then often he wants to run antiSMASH, choose run_antismash.\n"
